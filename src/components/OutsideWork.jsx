  ...
  return (
    <StyledGridContainer>
      <StyledCopy>
        ...
        <StyledText>
          Surfing, snowboarding and traveling are my biggest passions. When I’m
          not paddling out into the waves, you’ll probably find me at the gym,
          swimming in the lake, or cooking for family and friends.
        </StyledText>
        <StyledText>
          I’m calm and methodical by nature, which helps me handle challenges
          with clarity and ease. Working with people from different backgrounds
          and generations gives me a sense of purpose—and I find it endlessly
