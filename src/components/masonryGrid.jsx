...
const allMediaItems = [
  ...
  { src: "/Beauty.mp4", label: "AI Beauty Concept", isAI: true },
  { src: "/Avatar_May_TheElectricState.mp4", label: "AI Avatar - May Rosengren for AI News Reel", isAI: true },
  { src: "/sns_singles_day.gif", label: "SNS Singles Day (AI)", isAI: true },
];
